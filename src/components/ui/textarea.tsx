    ...
    return (
      <div className={cn("flex flex-col gap-1", className)}>
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            "border border-gray-300 px-3 py-2 text-sm min-h-[100px] resize-y focus:outline-none focus:ring-1",
            accountTheme
              ? "rounded-button focus:border-[var(--account-accent)] focus:ring-[var(--account-accent)]"
