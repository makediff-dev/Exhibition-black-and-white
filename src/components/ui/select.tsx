      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="relative">
          <select
            ...
            id={selectId}
            className={cn(
              "w-full appearance-none border border-gray-300 pl-3 pr-8 py-2 text-sm bg-white focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900",
              className
            )}
            {...props}
          >
