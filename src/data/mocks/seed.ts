...
export const SEED_DOCUMENTS: Document[] = [
  { id: "doc-1", type: "Договор", number: "ДГ-001/2026", dealId: "deal-1", date: "2026-01-12", parties: "Заказчик — Исполнитель", status: "signed" },
  { id: "doc-2", type: "Счёт", number: "СЧ-001/2026", dealId: "deal-1", date: "2026-01-13", parties: "Заказчик", status: "signed" },
  { id: "doc-3", type: "Акт", number: "АК-002/2026", dealId: "deal-2", date: "2026-01-16", parties: "Заказчик — Исполнитель", status: "sent" },
  { id: "doc-4", type: "УПД", number: "УПД-098/2025", dealId: "deal-4", date: "2025-07-12", parties: "Заказчик — Исполнитель", status: "archived" },
  { id: "doc-5", type: "Договор", number: "ДГ-097/2025", dealId: "deal-5", date: "2025-04-01", parties: "Заказчик — Исполнитель", status: "archived" },
  { id: "doc-6", type: "Счёт", number: "СЧ-003/2026", dealId: "deal-3", date: "2026-01-20", parties: "Заказчик", status: "draft" },
];
