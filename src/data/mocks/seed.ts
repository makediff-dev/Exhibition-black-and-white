...
export const SEED_DOCUMENTS: Document[] = [
  { id: "doc-1", type: "Договор", number: "ДГ-001/2026", dealId: "deal-1", date: "2026-01-12", parties: "Заказчик — Исполнитель", status: "signed", direction: "incoming", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  { id: "doc-2", type: "Счёт", number: "СЧ-001/2026", dealId: "deal-1", date: "2026-01-13", parties: "Экспонент — Организатор", status: "sent", direction: "incoming", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  ...
  { id: "doc-4", type: "УПД", number: "УПД-098/2025", dealId: "deal-4", date: "2025-07-12", parties: "Заказчик — Исполнитель", status: "archived", direction: "outgoing", eventId: "evt-5", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  ...
  { id: "doc-7", type: "Договор", number: "ДГ-095/2025", dealId: "deal-6", date: "2025-08-26", parties: "Заказчик — Исполнитель", status: "archived", direction: "incoming", eventId: "evt-3", organizerId: "user-organizer-forum", organizerName: "ООО «IT Forum Организатор»", venueId: "venue-1" },
  { id: "doc-8", type: "УПД", number: "УПД-095/2025", dealId: "deal-6", date: "2025-09-30", parties: "Заказчик — Исполнитель", status: "archived", direction: "outgoing", eventId: "evt-3", organizerId: "user-organizer-forum", organizerName: "ООО «IT Forum Организатор»", venueId: "venue-1" },
  { id: "doc-9", type: "Договор", number: "ДГ-ПАВ/2026", dealId: "deal-1", date: "2026-01-10", parties: "Площадка — Организатор", status: "signed", direction: "incoming", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  { id: "doc-10", type: "Акт", number: "АК-ПР/2026", dealId: "deal-1", date: "2026-02-01", parties: "Экспонент — Площадка", status: "sent", direction: "incoming", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  { id: "doc-11", type: "Счёт", number: "СЧ-ПР/2026", dealId: "deal-1", date: "2026-02-05", parties: "Застройщик — Площадка", status: "draft", direction: "incoming", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  { id: "doc-13", type: "Счёт", number: "СЧ-ПЛ/2026", dealId: "deal-1", date: "2026-01-11", parties: "Организатор — Площадка", status: "sent", direction: "outgoing", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
  { id: "doc-14", type: "Счёт", number: "СЧ-ЭКС/2026", dealId: "deal-1", date: "2026-02-03", parties: "Экспонент — Организатор", status: "draft", direction: "incoming", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", venueId: "venue-1" },
];
...
export const SEED_PAYMENTS: Payment[] = [
  ...
  { id: "pay-4", dealId: "deal-3", type: "Счёт к оплате", amount: 15000, status: "pending", date: "2026-01-20", description: "Ожидает оплаты", direction: "incoming" },
  { id: "pay-8", dealId: "deal-3", type: "Счёт к оплате", amount: 340000, status: "pending", date: "2026-07-26", description: "услуги по аренде мебели", direction: "incoming" },
  { id: "pay-9", dealId: "deal-1", type: "Счёт к оплате", amount: 520000, status: "pending", date: "2026-07-24", description: "услуги дизайн-проекта", direction: "incoming" },
  ...
  { id: "pay-7", dealId: "deal-1", type: "Счёт к оплате", amount: 120000, status: "pending", date: "2026-01-22", description: "Счёт конечному заказчику", direction: "outgoing" },
  { id: "vpay-1", venueId: "venue-1", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", participantRole: "organizer", counterpartyName: "ООО «МебельЭкспо Организатор»", type: "Счёт к оплате", amount: 1200000, status: "pending", date: "2026-01-10", description: "Аренда павильона 1 — Мебель-2026", direction: "incoming" },
  { id: "vpay-2", venueId: "venue-1", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", participantRole: "exhibitor", counterpartyName: "ООО «Вымышленная Мебель»", type: "Счёт к оплате", amount: 85000, status: "pending", date: "2026-02-05", description: "Площадь 36 кв.м + Wi-Fi — Мебель-2026", direction: "incoming" },
  { id: "vpay-3", venueId: "venue-1", eventId: "evt-1", organizerId: "user-organizer", organizerName: "ООО «МебельЭкспо Организатор»", participantRole: "contractor", counterpartyName: "ООО «СтендПро»", type: "Счёт к оплате", amount: 45000, status: "pending", date: "2026-02-08", description: "Пропуск на монтаж — Мебель-2026", direction: "incoming" },
  ...
  { id: "opay-1", organizerId: "user-organizer", eventId: "evt-1", participantRole: "venue", counterpartyName: "ЭкспоЦентр", type: "Счёт к оплате", amount: 1200000, status: "pending", date: "2026-01-10", description: "Аренда павильона 1 — Мебель-2026", direction: "outgoing" },
  { id: "opay-2", organizerId: "user-organizer", eventId: "evt-1", participantRole: "exhibitor", counterpartyName: "ООО «Вымышленная Мебель»", type: "Счёт к оплате", amount: 280000, status: "pending", date: "2026-02-03", description: "Аренда 36 кв.м — Мебель-2026", direction: "incoming" },
  ...
  { id: "opay-5", organizerId: "user-organizer", eventId: "evt-1", participantRole: "contractor", counterpartyName: "ООО «СтендПро»", type: "Счёт к оплате", amount: 45000, status: "pending", date: "2026-02-08", description: "Пропуска на монтаж — Мебель-2026", direction: "incoming" },
  ...
  { id: "opay-7", organizerId: "user-organizer", eventId: "evt-1", dealId: "deal-1", type: "Резерв", amount: 520000, status: "reserved", date: "2026-01-13", description: "Безопасная сделка — СД-2026-001", direction: "incoming" },
...
export const SEED_HALLS: VenueHall[] = [
  { id: "hall-1", venueId: "venue-1", pavilionId: "pav-1", name: "Зал 1 — партер", area: 2500, capacity: 100, available: true },
  { id: "hall-1b", venueId: "venue-1", pavilionId: "pav-1", name: "Зал 2 — галерея", area: 2500, capacity: 100, available: true },
...
export const SEED_VENUE_INQUIRIES: VenueInquiry[] = [
  {
    ...
    sentAt: "2026-03-15",
    proposalSummary: "Павильон 2, второй этаж",
